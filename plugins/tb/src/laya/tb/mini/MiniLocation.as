package laya.tb.mini
{
	...
	public class MiniLocation 
	{
		...
		{
			TBMiniAdapter.window.navigator.geolocation.getCurrentPosition = getCurrentPosition;
			TBMiniAdapter.window.navigator.geolocation.watchPosition = watchPosition;
			TBMiniAdapter.window.navigator.geolocation.clearWatch = clearWatch;
