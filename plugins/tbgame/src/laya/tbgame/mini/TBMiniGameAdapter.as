package laya.tbgame.mini
{
	...
	public class TBMiniGameAdapter {
		/**@private  包装对象**/
		...
		public static function init():void {
			...
			MiniFileMgr.existDir(MiniFileMgr.fileNativeDir, Handler.create(TBMiniGameAdapter, onMkdirCallBack));
