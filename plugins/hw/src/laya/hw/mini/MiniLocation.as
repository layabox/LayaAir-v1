package laya.hw.mini 
{
	...
	public class MiniLocation 
	{
		...
		{
			HWMiniAdapter.window.navigator.geolocation.getCurrentPosition = getCurrentPosition;
			HWMiniAdapter.window.navigator.geolocation.watchPosition = watchPosition;
			HWMiniAdapter.window.navigator.geolocation.clearWatch = clearWatch;
