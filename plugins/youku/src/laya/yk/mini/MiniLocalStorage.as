package laya.yk.mini
{
	...
	public class MiniLocalStorage
	{
		...
		public static function setItem(key:String, value:*):void {
			...
			try
			{
				YKMiniAdapter.window.my.setStorageSync({
					key:key,
					data:value
				});
			} 
			...
			{
				YKMiniAdapter.window.my.setStorage({
					key:key,
					data:value
				});
			}
		...
		public static function getItem(key:String):String {
			var data:Object = YKMiniAdapter.window.my.getStorageSync({"key":key});
			if (data.success)
				return data.data;
			return null;
		}
		...
		public static function removeItem(key:String):void {
			YKMiniAdapter.window.my.removeStorageSync(key);
		}
		...
		public static function clear():void {
			YKMiniAdapter.window.my.clearStorageSync();
		}
		...
		{
			try {
				var res:Object =YKMiniAdapter.window.my.getStorageInfoSync()
