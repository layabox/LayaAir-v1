package laya.yk.mini
{
	...
	public class MiniLocation 
	{
		...
		{
			YKMiniAdapter.window.navigator.geolocation.getCurrentPosition = getCurrentPosition;
			YKMiniAdapter.window.navigator.geolocation.watchPosition = watchPosition;
			YKMiniAdapter.window.navigator.geolocation.clearWatch = clearWatch;
		...
		public static function getCurrentPosition(success:Function=null, error:Function=null, options:Object=null):void
		{
			...
			paramO.fail = error;
			YKMiniAdapter.window.my.getLocation(paramO);
