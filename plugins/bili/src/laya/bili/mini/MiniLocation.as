package laya.bili.mini 
{
	...
	public class MiniLocation 
	{
		...
		{
			BLMiniAdapter.window.navigator.geolocation.getCurrentPosition = getCurrentPosition;
			BLMiniAdapter.window.navigator.geolocation.watchPosition = watchPosition;
			BLMiniAdapter.window.navigator.geolocation.clearWatch = clearWatch;
