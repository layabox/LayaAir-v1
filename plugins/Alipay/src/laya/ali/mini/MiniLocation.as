package laya.ali.mini
{
	...
	public class MiniLocation 
	{
		...
		{
			ALIMiniAdapter.window.navigator.geolocation.getCurrentPosition = getCurrentPosition;
			ALIMiniAdapter.window.navigator.geolocation.watchPosition = watchPosition;
			ALIMiniAdapter.window.navigator.geolocation.clearWatch = clearWatch;
