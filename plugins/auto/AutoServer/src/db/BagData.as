package db {
	...
	public class BagData extends MessageBase {
		...
		public function init(id:Number, num:Number, type:Number):BagData {
			this._id = id;
			this._num = num;
			this._type = type;
			return this;
		...
		public static const DES:Array = [["id", MessageBase.UINT32], ["num", MessageBase.UINT16], ["type", MessageBase.UINT8]];
	}
