package laya.tt.mini {
	...
	public class MiniInput {
		...
		private static function _createInputElement():void {
			...
			TTMiniAdapter.window.tt.onWindowResize && TTMiniAdapter.window.tt.onWindowResize(function(res:*):void {
			...
			//运行环境判断
			var model:String= TTMiniAdapter.systemInfo.model;
			var system:String = TTMiniAdapter.systemInfo.system;
		...
		public static function inputFocus(e:*):void {
			...
			TTMiniAdapter.window.tt.showKeyboard({defaultValue: _inputTarget.text, maxLength: _inputTarget.maxChars, multiple: _inputTarget.multiline, confirmHold: true, confirmType: 'done', success: function(res:*):void {
			}, fail: function(res:*):void {
			}});
			
			TTMiniAdapter.window.tt.onKeyboardConfirm(function(res:*):void {
				var str:String = res ? res.value : "";
				_inputTarget.text = str;
				_inputTarget.event(Event.INPUT)
				MiniInput.inputEnter();
			})
			TTMiniAdapter.window.tt.onKeyboardInput(function(res:*):void {
				var str:String = res ? res.value : "";
		...
		public static function inputblur():void {
			hideKeyboard();
		}
		...
		public static function hideKeyboard():void {
			TTMiniAdapter.window.tt.offKeyboardConfirm();
			TTMiniAdapter.window.tt.offKeyboardInput();
			TTMiniAdapter.window.tt.hideKeyboard({success: function(res:*):void {
				console.log('隐藏键盘')
			}, fail: function(res:*):void {
