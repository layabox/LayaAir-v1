package {
	...
	public class PerformanceTest_Maggots {
		...
		public static const TestName:String = "Maggots";
		
		private var texturePath:String = "./res/maggot/tinyMaggot.png";
		
		private var padding:int = 100;
		private var maggotAmount:int = 26000;
		...
		public function PerformanceTest_Maggots(testIndex:int) {
			_testIndex = testIndex;
			trace("hi test PerformanceTest_Maggots.");
