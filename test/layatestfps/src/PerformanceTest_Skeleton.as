package {
	...
	public class PerformanceTest_Skeleton {
		...
		public static const TestName:String = "Skeleton";
		...
		private var rowCount:int = 12;
		private var colCount:int = 11;
		...
		public function PerformanceTest_Skeleton(testIndex:int) {
		...
		public function clear():void {
			mFactory.destroy();
			//mArmature.destroy();
			Laya.stage.off(Event.CLICK, this, toggleAction);
			Laya.loader.clearUnLoaded();
			Laya.loader.clearRes(mTexturePath);
			Laya.loader.clearRes(mAniPath);
		}
	}
}