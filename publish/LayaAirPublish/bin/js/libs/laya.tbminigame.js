...
var MiniFileMgr$12=(function(){
	function MiniFileMgr(){}
	__class(MiniFileMgr,'laya.tb.mini.MiniFileMgr',null,'MiniFileMgr$12');
...
var MiniImage$12=(function(){
	function MiniImage(){}
	__class(MiniImage,'laya.tb.mini.MiniImage',null,'MiniImage$12');
...
var MiniInput$12=(function(){
	function MiniInput(){}
	__class(MiniInput,'laya.tb.mini.MiniInput',null,'MiniInput$12');
...
var MiniLocalStorage$11=(function(){
	function MiniLocalStorage(){}
	__class(MiniLocalStorage,'laya.tb.mini.MiniLocalStorage',null,'MiniLocalStorage$11');
...
var MiniLocation$12=(function(){
	function MiniLocation(){}
	__class(MiniLocation,'laya.tb.mini.MiniLocation',null,'MiniLocation$12');
...
var MiniVideo$10=(function(){
	...
	__class(MiniVideo,'laya.tb.mini.MiniVideo',null,'MiniVideo$10');
...
var TBMiniGameAdapter=(function(){
	...
	TBMiniGameAdapter.init=function(){
		...
		MiniFileMgr$12.existDir(MiniFileMgr$12.fileNativeDir,Handler.create(TBMiniGameAdapter,TBMiniGameAdapter.onMkdirCallBack));
	...
	TBMiniGameAdapter.createElement=function(type){
		if (type=="canvas"){
			...
			if (TBMiniGameAdapter.idx==1){
				_source=TBMiniGameAdapter.window.canvas.getRealCanvas();
				}else {
...
var MiniAccelerator$12=(function(_super){
	function MiniAccelerator(){
		MiniAccelerator.__super.call(this);
	}

	__class(MiniAccelerator,'laya.tb.mini.MiniAccelerator',_super,'MiniAccelerator$12');
...
var MiniLoader$12=(function(_super){
	function MiniLoader(){
		MiniLoader.__super.call(this);
	}

	__class(MiniLoader,'laya.tb.mini.MiniLoader',_super,'MiniLoader$12');
		...
		if ((MiniLoader._fileTypeArr.indexOf(urlType)!=-1)|| type==/*laya.net.Loader.IMAGE*/"image"){
			...
			if (!MiniFileMgr$12.getFileInfo(url)){
				if (MiniFileMgr$12.isLocalNativeFile(url)){
					...
					MiniFileMgr$12.readFile(TBMiniGameAdapter.baseDir+ResourceVersion.addVersionPrefix(url),encoding,new Handler(MiniLoader,MiniLoader.onReadNativeCallBack,[encoding,url,type,cache,group,ignoreCache,thisLoader]));
					}else{
					var tempUrl=url;
					...
					if(fileObj){
						...
						if(type !=/*laya.net.Loader.IMAGE*/"image" && ((url.indexOf("http://")==-1 && url.indexOf("https://")==-1))){
							MiniFileMgr$12.readFile(TBMiniGameAdapter.baseDir+url,encoding,new Handler(MiniLoader,MiniLoader.onReadNativeCallBack,[encoding,url,type,cache,group,ignoreCache,thisLoader]),url);
							}else{
							MiniFileMgr$12.downFiles(encodeURI(url),encoding,new Handler(MiniLoader,MiniLoader.onReadNativeCallBack,[encoding,url,type,cache,group,ignoreCache,thisLoader]),url,TBMiniGameAdapter.AutoCacheDownFile);
						}
					}
				}
				}else {
...
var MiniSound$12=(function(_super){
	function MiniSound(){
		/**@private **/
		this._sound=null;
		/**
	...
	__class(MiniSound,'laya.tb.mini.MiniSound',_super,'MiniSound$12');
	...
	*/
	__proto.load=function(url){
		...
		this.url=url;
		this.readyUrl=url;
		if(TBMiniGameAdapter.autoCacheFile&&MiniFileMgr$12.getFileInfo(url)){
			...
			if(!TBMiniGameAdapter.autoCacheFile){
				...
				if (MiniFileMgr$12.isLocalNativeFile(url)){
					...
					if ((url.indexOf("http://")==-1 && url.indexOf("https://")==-1)
						...
						MiniFileMgr$12.downOtherFiles(url,Handler.create(this,this.onDownLoadCallBack,[url]),url,TBMiniGameAdapter.autoCacheFile);
					}
				}
			}
		}
...
var MiniSoundChannel$12=(function(_super){
	...
	__class(MiniSoundChannel,'laya.tb.mini.MiniSoundChannel',_super,'MiniSoundChannel$12');
