package laya.tb.mini
{
	...
	public class MiniLocation 
	{
		...
		{
			TBMiniGameAdapter.window.navigator.geolocation.getCurrentPosition = getCurrentPosition;
			TBMiniGameAdapter.window.navigator.geolocation.watchPosition = watchPosition;
			TBMiniGameAdapter.window.navigator.geolocation.clearWatch = clearWatch;
