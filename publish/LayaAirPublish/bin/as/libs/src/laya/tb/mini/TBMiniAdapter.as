package laya.tb.mini
{
	...
	public class TBMiniAdapter {
		...
		/**默认的目录层级*/
		public static var baseDir:String = "pages/index/";
		/**@private **/
		...
		public static function init():void {
			...
			MiniFileMgr.existDir(MiniFileMgr.fileNativeDir, Handler.create(TBMiniAdapter, onMkdirCallBack));
