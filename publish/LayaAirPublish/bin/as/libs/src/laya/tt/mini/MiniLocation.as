package laya.tt.mini 
{
	...
	public class MiniLocation 
	{
		...
		{
			TTMiniAdapter.window.navigator.geolocation.getCurrentPosition = getCurrentPosition;
			TTMiniAdapter.window.navigator.geolocation.watchPosition = watchPosition;
			TTMiniAdapter.window.navigator.geolocation.clearWatch = clearWatch;
